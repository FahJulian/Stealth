...
public class Renderer2D
{
        ...
        static
        {
                ...
                TEXTURED_RECTANGLE_SHADER = new Shader("src/main/resources/shaders/textured_rectangle.glsl");
        ...
        {
                drawRectangle(new Vector3f(position, 0.0f), new Vector3f(size, 1.0f), new Vector3f(), color);
        }

        public static void drawRectangle(Vector2f position, Vector2f size, float rotation, Vector4f color)
        {
                drawRectangle(new Vector3f(position, 0.0f), new Vector3f(size, 1.0f),
                                new Vector3f(0.0f, 0.0f, rotation), color);
        }

        public static void drawRectangle(float x, float y, float width, float height, Vector4f color)
        {
        ...
        {
                drawTexturedRectangle(new Vector3f(x, y, 0.0f), new Vector3f(width, height, 1.0f), new Vector3f(),
                                texture);
        }

        public static void drawTexturedRectangle(Vector3f position, Vector3f size, Vector3f rotation, Texture2D texture)
        {
                ...
                TEXTURED_RECTANGLE_SHADER.setUniform("uViewMatrix",
                                AApplication.get().getScene().getCamera().getViewMatrix());
        ...
        public static void drawRectangle(Vector3f position, Vector3f size, Vector3f rotation, Vector4f color)
        {
                position = new Vector3f(position.x + size.x / 2.0f, position.y + size.y / 2.0f,
                                position.z + size.z / 2.0f);
