...
// * the file.
// */
// static void saveMap(int width, int height, float tileSize, float posZ,
// Set<AbstractTexture> textures,
...
// private static Sprite loadTile(Scanner scanner, List<AbstractTexture>
// textures)
// {
...
// break;
// case "textureIndex":
// texture = textures.get(Integer.valueOf(Toolbox.stripXmlTags(line,
// "textureIndex")));
// assert textureType != null : Log.error("(tilemap.FileHandler) Error loading
// map: Invalid tag order.");
...
// if (isSpritesheet)
// return SerializablePool.getLoaded(new Spritesheet(path, width, height,
// spriteWidth, spriteHeight, padding));
// else
// return SerializablePool.getLoaded(new Texture(path));
// }

// private static String serializeTile(TileComponent tile, List<AbstractTexture>
// textures)
// {
// final String SPRITESHEET = "spritesheet", TEXTURE2D = "texture";
// String textureType = tile.getSprite().getTexture() instanceof Spritesheet ?
...
// if (textureType.equals(SPRITESHEET))
// {
// int[] sheetPos = ((Spritesheet)
// tile.getSprite().getTexture()).posOf(tile.getSprite());
...
// sb.append(String.format(" <type>%s</type>%n", isSpritesheet ? "spritesheet" :
// "texture"));
...
// sb.append(String.format(" <spriteWidth>%d</spriteWidth>%n",
// spritesheet.getSpriteWidth()));
// sb.append(String.format(" <spriteHeight>%d</spriteHeight>%n",
// spritesheet.getSpriteHeight()));
// sb.append(String.format(" <padding>%d</padding>%n",
// spritesheet.getPadding()));
// }
