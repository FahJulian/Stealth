...
public final class Log {
     ...
     * @param args Arguments to pass to the jave formatter
     */
    ...
    private void write(Level level, String message) {
        ...
        try {
            ...
            writer.write(String.format("[%s] %s: %s%n", level.name, new SimpleDateFormat("HH:mm:ss").format(new Date()), message));
            writer.close();
