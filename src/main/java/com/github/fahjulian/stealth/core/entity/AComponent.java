...
public abstract class AComponent
{
     ...
     */
    protected <E extends AEvent> void addEventListener(Class<E> eventClass,
            IEventListener<E> listener)
    {
        if (entity == null || entity.getLayer() == null)
        {
            Log.warn(
                    "Cant add Event Listener to a component that has not been assigned an entity that is part of a layer.");
            return;
        }
