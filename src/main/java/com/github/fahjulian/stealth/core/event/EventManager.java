...
public final class EventManager {
     ...
     * @param index      The "importance" of the listener (Like a zIndex in
     *                   rendering)
     */
    ...
    /**
     * Register an EventListener for its type of Event with a condition for it getting called
     * @param <E>        The class of the EventListener's event
     * @param eventClass The class of the Event the eventlistener listens to
     * @param listener   The EventListener to register
     * @param condition  A Supplier for Boolean that checks whether or not the EventListener should be called
     * @param index      The "importance" of the listener (Like a zIndex in
     *                   rendering)
     */
    public <E extends AEvent> void addListener(Class<E> eventClass, IEventListener<E> listener, IEventListenerCondition condition, int index) {
